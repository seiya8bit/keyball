...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  // Scroll
  [5] = LAYOUT_universal(
    KBC_SAVE        , _______        , DT_PRNT        , _______        , AML_TO         ,                                   _______        , _______        , _______        , _______        , _______        ,
    _______         , _______        , DT_UP          , CPI_I100       , AML_I50        ,                                   _______        , _______        , _______        , _______        , _______        ,
    EE_CLR          , _______        , DT_DOWN        , CPI_D100       , AML_D50        ,                                   _______        , _______        , _______        , _______        , _______        ,
    _______         , _______        , _______        , _______        , _______        , _______        , _______        , _______        , _______        , _______        , _______        , _______
  ),
