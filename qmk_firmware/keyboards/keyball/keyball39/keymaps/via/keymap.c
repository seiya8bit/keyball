...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = LAYOUT_universal(
    ...
    LSFT_T(KC_ESC)  , KC_PSCR        , KC_LGUI        , MO(3)          , KC_LALT        , MO(2)          , LT(1, KC_SPC)  , KC_RCTL        , _______        , _______        , _______        , KC_RSFT
  ),
  ...
  // Mouse
  [4] = LAYOUT_universal(
    _______         , _______        , _______        , _______        , AML_TO         ,                                   _______        , _______        , _______        , _______        , _______        ,
    _______         , _______        , _______        , CPI_I100       , AML_I50        ,                                   _______        , KC_BTN1        , KC_BTN3        , KC_BTN2        , _______        ,
